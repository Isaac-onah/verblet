...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<String> _categories = ['All', 'Technology', 'Lifestyle', 'Business', 'Culture'];
  String _selectedCategory = 'All';

  // --- Mock Data ---
  final List<Article> _recommendedArticles = [
    Article(
      imageUrl: 'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
      category: 'Technology',
    ...
    Article(
      imageUrl: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
      category: 'Technology',
  ...
  final List<Article> _trendingArticles = [
    Article(
      imageUrl: 'https://images.unsplash.com/photo-1534644107580-3a4dbd494a95?q=80&w=600&auto=format&fit=crop',
      category: 'Technology',
    ...
    Article(
      imageUrl: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
      category: 'Business',
    ...
    Article(
      imageUrl: 'https://images.unsplash.com/photo-1512152272829-e3139592d56f?q=80&w=600&auto=format&fit=crop',
      category: 'Lifestyle',
        ...
        itemBuilder: (context, index) {
          if (index == _recommendedArticles.length - 1) {
            return Padding(
              ...
              child: RecommendedCard(article: _recommendedArticles[index]),
            );
          }
          return RecommendedCard(article: _recommendedArticles[index]);
        },
      ),
    );
  }
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: ChoiceChip(
              ...
              shape: RoundedRectangleBorder(side: BorderSide(color: Colors.grey.shade300),    borderRadius: BorderRadius.circular(8.0), // Adjust the radius here
              ),
              showCheckmark: false,
            ),
          );
  ...
  Widget _buildTrendingList() {
    return ListView.builder(
      ...
      physics: const NeverScrollableScrollPhysics(), // Disables its own scrolling
      itemBuilder: (context, index) {
