...
// constraints: const BoxConstraints.expand (height: 14.inputFieldHeight),
  ...
  static TextSelectionThemeData TextSelectionTheme = TextSelectionThemeData(
    cursorColor: MyColors.primary, // Customize the cursor color
    selectionColor: MyColors.primary.withOpacity(0.3), // Customize the selection color
    selectionHandleColor: MyColors.primary, // Customize the selection handle color
  );
